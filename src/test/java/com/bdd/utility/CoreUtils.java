...
import com.bdd.utility.RemoteDriverFactory;
import com.bdd.utility.LocalDriverFactory;
...
public class CoreUtils{
	...
	public void initializeWebDriver() {
		...
		try {
			...
			FileInputStream file = new FileInputStream("C:\\Selenium\\WorkSpace\\Java_Cucumber_Selenium_TestNg\\Resources\\Config\\Sys.properties");
			ps = new Properties();
			ps.load(file);
		} catch (IOException e) {
			e.printStackTrace();
